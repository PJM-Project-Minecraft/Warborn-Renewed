...
public final class ArmorAttributeSpec {
    ...
    public AttributeModifier createModifier(ResourceLocation id, ItemStack stack, String itemId, EquipmentSlot slot) {
        ...
        // В 1.21.1 AttributeModifier принимает ResourceLocation вместо UUID и name
        ResourceLocation modifierId = Warbornrenewed
                .id(itemId.replace(":", "_") + "/" + idSuffix + "/" + slot.getName());
