...
public class TACZIntegration {
    ...
    public static void init() {
        ...
        try {
            ...
            ResourceLocation taczAttrId = ResourceLocation.fromNamespaceAndPath(TACZ_MOD_ID, "tacz.bullet_resistance");
            taczBulletResistance = BuiltInRegistries.ATTRIBUTE.get(taczAttrId);
